...
const CURRICULUM = [
  ...
  { week: 5, title: 'Alegerea Identității', description: 'Discuție liberă.' },
  { week: 6, title: 'Circumstanțe', description: 'Discuție liberă.' },
  { week: 7, title: 'Noua realitate', description: 'Discuție liberă.' },
  { week: 8, title: 'Concluzii și recapitulare', description: 'Discuție liberă.' },
]
