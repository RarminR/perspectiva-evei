const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://www.google-analytics.com https://*.revolut.com https://video.bunnycdn.com https://*.b-cdn.net https://iframe.mediadelivery.net",
      "media-src 'self' blob: https://*.cloudfront.net https://*.b-cdn.net https://iframe.mediadelivery.net",
